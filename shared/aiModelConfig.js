export const PRIMARY_AI_MODEL = 'gemini-3.5-flash';
...
export const AI_MODEL_CONFIG = Object.freeze({
  [PRIMARY_AI_MODEL]: Object.freeze({
    ...
    bestFor: 'วิเคราะห์ข้อมูล RAG กราฟ และคำแนะนำเชิงบริหาร',
    searchCapable: true,
  ...
  [FALLBACK_AI_MODEL]: Object.freeze({
    ...
    bestFor: 'คำถามทั่วไปและโมเดลสำรองที่รวดเร็ว',
    searchCapable: true,
...
export const AI_SEARCH_MODEL_ORDER = Object.freeze(
  [PRIMARY_AI_MODEL, LEGACY_SEARCH_FALLBACK_AI_MODEL, FALLBACK_AI_MODEL]
