...
const ROLE_OPTIONS = [
    {
        ...
        pending: false,
        icon: User,
        gradient: 'linear-gradient(135deg, var(--accent-purple), var(--accent-purple))',
    ...
    },
    {
        ...
        pending: true,
        icon: Briefcase,
        gradient: 'linear-gradient(135deg, var(--accent-success-deep), var(--accent-success))',
        title: 'เจ้าหน้าที่',
        subtitle: 'Staff',
    ...
    },
    {
        ...
        description: 'หัวหน้า/ประธานหลักสูตร มีสิทธิ์ดูข้อมูลเชิงลึก รายงาน และวางแผนงบประมาณ ต้องผ่านการอนุมัติจากคณบดี',
        features: [
                        ...
                        <div className="login-form signup-step-content">
                            ...
                            <div className="signup-pending-notice">
                                ...
                                <div>
                                    ...
                                    <p>คำขอของคุณจะถูกส่งให้คณบดีตรวจสอบ สามารถใช้งานระดับทั่วไปได้ก่อนระหว่างรอการอนุมัติ</p>
                                </div>
                            </div>
                        </div>
                    )}
