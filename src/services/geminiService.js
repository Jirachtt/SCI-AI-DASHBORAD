...
function normalizeAIUsageSnapshot(value = {}) {
    ...
    return {
        ...
        aiReady: typeof value.aiReady === 'boolean' ? value.aiReady : null,
...
function updateAITokenBudgetFromHeaders(headers) {
    ...
    return setAIUsageSnapshot({
        ...
        resetLabel: null,
        source,
        aiReady: remaining > 0 && Number(headers.get('X-AI-Requests-Remaining') || 1) > 0,
        readinessReason: remaining > 0 ? 'ready' : 'daily_budget_exhausted',
        serverBacked: true,
        policy: {
