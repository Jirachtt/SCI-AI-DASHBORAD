...
// ข้อมูลรายชื่อนักศึกษาจาก MJU Dashboard (ตัวอย่างข้อมูลจริง)
export const scienceStudentList = [
    // ===== รหัส 65 (ปี 4) =====
    ...
    { id: '6501104301', prefix: 'นาย', name: 'ธีรภัทร รัตนากร', major: 'สถิติและการจัดการสารสนเทศ', level: 'ปริญญาตรี', year: 4, status: 'กำลังศึกษา', gpa: 2.95 },
    { id: '6501104302', prefix: 'นางสาว', name: 'นภัสสร แสงจันทร์', major: 'สถิติและการจัดการสารสนเทศ', level: 'ปริญญาตรี', year: 4, status: 'กำลังศึกษา', gpa: 3.48 },
    ...
    { id: '6501108301', prefix: 'นางสาว', name: 'สิรินทรา วงค์แก้ว', major: 'ชีววิทยา', level: 'ปริญญาตรี', year: 4, status: 'กำลังศึกษา', gpa: 2.91 },
    { id: '6501108302', prefix: 'นาย', name: 'อภิสิทธิ์ ใจปัญญา', major: 'ชีววิทยา', level: 'ปริญญาตรี', year: 4, status: 'กำลังศึกษา', gpa: 1.85 },
    { id: '6501109301', prefix: 'นางสาว', name: 'กชกร สมนึก', major: 'นวัตกรรมเคมีอุตสาหกรรม', level: 'ปริญญาตรี', year: 4, status: 'กำลังศึกษา', gpa: 3.45 },
    { id: '6501110301', prefix: 'นาย', name: 'พงศกร ไชยวงค์', major: 'วิทยาการข้อมูล', level: 'ปริญญาตรี', year: 4, status: 'กำลังศึกษา', gpa: 3.67 },
    // ===== รหัส 66 (ปี 3) =====
    ...
    { id: '6601104301', prefix: 'นาย', name: 'กนกพิชญ์ ถาอ้าย', major: 'สถิติและการจัดการสารสนเทศ', level: 'ปริญญาตรี', year: 3, status: 'กำลังศึกษา', gpa: 3.05 },
    { id: '6601104302', prefix: 'นางสาว', name: 'ปรารถนา อุ่นใจ', major: 'สถิติและการจัดการสารสนเทศ', level: 'ปริญญาตรี', year: 3, status: 'กำลังศึกษา', gpa: 3.71 },
    ...
    { id: '6601108301', prefix: 'นางสาว', name: 'วรัญญา สีดา', major: 'ชีววิทยา', level: 'ปริญญาตรี', year: 3, status: 'กำลังศึกษา', gpa: 3.08 },
    { id: '6601108302', prefix: 'นาย', name: 'รัฐพล บุตรดี', major: 'ชีววิทยา', level: 'ปริญญาตรี', year: 3, status: 'กำลังศึกษา', gpa: 2.35 },
    { id: '6601109301', prefix: 'นางสาว', name: 'สุพิชชา ปัญญาวงค์', major: 'นวัตกรรมเคมีอุตสาหกรรม', level: 'ปริญญาตรี', year: 3, status: 'กำลังศึกษา', gpa: 3.25 },
    { id: '6601110301', prefix: 'นาย', name: 'ปฏิพัทธ์ รินทร์แก้ว', major: 'วิทยาการข้อมูล', level: 'ปริญญาตรี', year: 3, status: 'กำลังศึกษา', gpa: 3.75 },
    { id: '6601110302', prefix: 'นางสาว', name: 'พิมพ์ลภัส จ๋อมแก้ว', major: 'วิทยาการข้อมูล', level: 'ปริญญาตรี', year: 3, status: 'กำลังศึกษา', gpa: 3.45 },
    // ===== รหัส 67 (ปี 2) =====
    ...
    { id: '6701104301', prefix: 'นางสาว', name: 'จารุวรรณ ศรีบุญเรือง', major: 'สถิติและการจัดการสารสนเทศ', level: 'ปริญญาตรี', year: 2, status: 'กำลังศึกษา', gpa: 3.15 },
    { id: '6701104302', prefix: 'นาย', name: 'พงศ์ภัค ทับทิม', major: 'สถิติและการจัดการสารสนเทศ', level: 'ปริญญาตรี', year: 2, status: 'กำลังศึกษา', gpa: 2.78 },
    ...
    { id: '6701108301', prefix: 'นาย', name: 'ทิวากร เมืองมูล', major: 'ชีววิทยา', level: 'ปริญญาตรี', year: 2, status: 'กำลังศึกษา', gpa: 2.81 },
    { id: '6701108302', prefix: 'นางสาว', name: 'สุทธิดา ยะเชียงแก้ว', major: 'ชีววิทยา', level: 'ปริญญาตรี', year: 2, status: 'กำลังศึกษา', gpa: 3.55 },
    { id: '6701109301', prefix: 'นาย', name: 'พุฒิพงศ์ ชุมภู', major: 'นวัตกรรมเคมีอุตสาหกรรม', level: 'ปริญญาตรี', year: 2, status: 'กำลังศึกษา', gpa: 3.02 },
    { id: '6701109302', prefix: 'นางสาว', name: 'อมลวรรณ แสนสุข', major: 'นวัตกรรมเคมีอุตสาหกรรม', level: 'ปริญญาตรี', year: 2, status: 'กำลังศึกษา', gpa: 3.72 },
    { id: '6701110301', prefix: 'นาย', name: 'ศิวกร อ่อนสา', major: 'วิทยาการข้อมูล', level: 'ปริญญาตรี', year: 2, status: 'กำลังศึกษา', gpa: 3.85 },
    { id: '6701110302', prefix: 'นางสาว', name: 'ธิดารัตน์ ปันแก้ว', major: 'วิทยาการข้อมูล', level: 'ปริญญาตรี', year: 2, status: 'กำลังศึกษา', gpa: 3.25 },
    { id: '6701110303', prefix: 'นาย', name: 'นพรุจ วิชัยวงค์', major: 'วิทยาการข้อมูล', level: 'ปริญญาตรี', year: 2, status: 'กำลังศึกษา', gpa: 2.92 },
    // ===== รหัส 68 (ปี 1) =====
    ...
    { id: '6801104301', prefix: 'นางสาว', name: 'กุลธิดา เทียนชัย', major: 'สถิติและการจัดการสารสนเทศ', level: 'ปริญญาตรี', year: 1, status: 'กำลังศึกษา', gpa: 3.28 },
    { id: '6801104302', prefix: 'นาย', name: 'ภูรินทร์ จันทร์มูล', major: 'สถิติและการจัดการสารสนเทศ', level: 'ปริญญาตรี', year: 1, status: 'กำลังศึกษา', gpa: 2.82 },
    { id: '6801104303', prefix: 'นางสาว', name: 'สิริยากร วิวัฒน์', major: 'สถิติและการจัดการสารสนเทศ', level: 'ปริญญาตรี', year: 1, status: 'กำลังศึกษา', gpa: 3.65 },
    ...
    { id: '6801108301', prefix: 'นาย', name: 'อนุวัฒน์ ลำพึง', major: 'ชีววิทยา', level: 'ปริญญาตรี', year: 1, status: 'กำลังศึกษา', gpa: 2.75 },
    { id: '6801108302', prefix: 'นางสาว', name: 'ปิยวรรณ ทิพย์จักร', major: 'ชีววิทยา', level: 'ปริญญาตรี', year: 1, status: 'กำลังศึกษา', gpa: 3.32 },
    { id: '6801108303', prefix: 'นาย', name: 'ไกรวิชญ์ อ้อยหวาน', major: 'ชีววิทยา', level: 'ปริญญาตรี', year: 1, status: 'กำลังศึกษา', gpa: 1.88 },
    { id: '6801109301', prefix: 'นางสาว', name: 'ปวันรัตน์ สุมาลี', major: 'นวัตกรรมเคมีอุตสาหกรรม', level: 'ปริญญาตรี', year: 1, status: 'กำลังศึกษา', gpa: 3.42 },
    { id: '6801109302', prefix: 'นาย', name: 'ศักดิ์ชัย ประเสริฐ', major: 'นวัตกรรมเคมีอุตสาหกรรม', level: 'ปริญญาตรี', year: 1, status: 'กำลังศึกษา', gpa: 2.92 },
    { id: '6801110301', prefix: 'นางสาว', name: 'อภิชญา สิริกุล', major: 'วิทยาการข้อมูล', level: 'ปริญญาตรี', year: 1, status: 'กำลังศึกษา', gpa: 3.78 },
    { id: '6801110302', prefix: 'นาย', name: 'จิรายุ ชัยเทพ', major: 'วิทยาการข้อมูล', level: 'ปริญญาตรี', year: 1, status: 'กำลังศึกษา', gpa: 3.35 },
    { id: '6801110303', prefix: 'นาย', name: 'ปัณณวิชญ์ ขันแก้ว', major: 'วิทยาการข้อมูล', level: 'ปริญญาตรี', year: 1, status: 'กำลังศึกษา', gpa: 3.05 },
    { id: '6801110304', prefix: 'นางสาว', name: 'รมิตา สาริกัน', major: 'วิทยาการข้อมูล', level: 'ปริญญาตรี', year: 1, status: 'กำลังศึกษา', gpa: 3.62 },
    // ===== บัณฑิตศึกษา =====
    ...
    { id: '6601301301', prefix: 'นางสาว', name: 'สุวรรณี อินทะสอน', major: 'ชีววิทยา', level: 'ปริญญาเอก', year: 2, status: 'กำลังศึกษา', gpa: 3.88 },
];
